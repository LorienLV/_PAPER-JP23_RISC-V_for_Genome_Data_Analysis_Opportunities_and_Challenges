...
inputs_path="$GENARCH_BENCH_INPUTS_ROOT/kmer-cnt/tiny"
...
command_opts="--reads \"$inputs_path/Loman_E.coli_MAP006-1_2D_50x_100.fasta\" \
              --config \"$configfolder/asm_raw_reads.cfg\" --kmer 4 \
              --debug --threads \$OMP_NUM_THREADS"
