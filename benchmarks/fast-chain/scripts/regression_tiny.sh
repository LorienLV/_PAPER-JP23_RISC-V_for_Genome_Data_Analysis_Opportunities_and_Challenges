...
inputs_path="$GENARCH_BENCH_INPUTS_ROOT/chain/tiny"
...
# The name of the job.
job="FAST-CHAIN-REGRESSION-TINY"
...
command_opts="-i \"$inputs_path/in-1.txt\" -o out.txt -t \$OMP_NUM_THREADS"
