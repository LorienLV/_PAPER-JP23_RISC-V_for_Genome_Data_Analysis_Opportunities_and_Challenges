...
inputs_path="$GENARCH_BENCH_INPUTS_ROOT/wfa/tiny"
...
command_opts="-i \"$inputs_path/WFA_SRR7733443_5_input.txt\" -o checksum.file -t \$OMP_NUM_THREADS"
