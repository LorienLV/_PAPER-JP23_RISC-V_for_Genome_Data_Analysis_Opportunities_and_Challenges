...
inputs_path="$GENARCH_BENCH_INPUTS_ROOT/bpm/tiny"
...
QEMUVM)
    ...
    commands=(
        "$binaries_path/bin_EPI_CC/align_benchmark"
    )
...
command_opts="-a bpm-edit -i \"$inputs_path/BPM_SRR7733443_100_input.txt\" -o checksum.file -t \$OMP_NUM_THREADS"
